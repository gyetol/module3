        ...
        <ul class="list-group list-group-flush">
            <li class="list-group-item">
                <div class="row">
                    ...
                    <div class="col-9" style="padding-left: 0">
                        <h5>매장이름&nbsp;&nbsp;<span class="badge badge-danger">승인 대기</span></h5>
                        매장 전화번호 : <span>02-123-4567</span>
                        <br/>
                        위치 : <span>대한민국 어딘가</span>
                    </div>
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="row">
                    ...
                    <div class="col-9" style="padding-left: 0">
                        <h5>매장이름&nbsp;&nbsp;<span class="badge badge-primary">승인 완료</span></h5>
                        매장 전화번호 : <span>02-123-4567</span>
                        <br/>
                        위치 : <span>대한민국 어딘가</span>
                    </div>
