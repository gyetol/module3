...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="nav-item text-center nav_three"><a href="${pageContext.request.contextPath}/ad/all-/all-/1/store" class="nav-link active">ALL</a></li>
		<li class="nav-item text-center nav_three"><a href="${pageContext.request.contextPath}/ad/신청/all-/1/store" class="nav-link" >승인 대기</a></li>
		<li class="nav-item text-center nav_three"><a href="${pageContext.request.contextPath}/ad/승인/all-/1/store" class="nav-link">승인 완료</a></li>
	</ul>
						...
						<li class="list-group-item">
							<div class="row">
								...
								<div class="col-9" style="padding-left: 0">
									<h5>
										<c:out value="${store.name}"/>&nbsp;&nbsp;<span class="badge badge-danger"><c:out value="${store.state.name}"/></span>
									</h5>
									매장 전화번호 : <span><c:out value="${store.phone}"/></span> <br /> 위치 : <span><c:out value="${store.address}"/></span>
								</div>
							</div>
						</li>
					</ul>
